...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype._calculate_set_once_properties = function (dataSetOnce) {
        ...
        var sessionProps = (_a = this.sessionPropsManager) === null || _a === void 0 ? void 0 : _a.getSetOnceInitialSessionPropsProps();
    ...
    PostHog.prototype.identify = function (new_distinct_id, userPropertiesToSet, userPropertiesToSetOnce) {
        ...
        if (new_distinct_id !== previous_distinct_id && isKnownAnonymous) {
            ...
            if (this._cachedIdentify !== getIdentifyHash(new_distinct_id, userPropertiesToSet, userPropertiesToSetOnce)) {
    ...
    PostHog.prototype.captureException = function (error, additionalProperties) {
        ...
        var properties = isFunction((_a = assignableWindow.__PosthogExtensions__) === null || _a === void 0 ? void 0 : _a.parseErrorAsProperties)
            ? __assign(__assign({}, assignableWindow.__PosthogExtensions__.parseErrorAsProperties(isError(error) ? { error: error, event: error.message } : { event: error }, 
            ...
            { syntheticException: syntheticException })), additionalProperties) : __assign({ $exception_level: 'error', $exception_list: [
                {
