...
var logger = createLogger('[FeatureFlags]');
...
var PostHogFeatureFlags = /** @class */ (function () {
    function PostHogFeatureFlags(instance) {
        ...
        this._decideCalled = false;
        this._flagsLoadedFromRemote = false;
        this.featureFlagEventHandlers = [];
    }
    PostHogFeatureFlags.prototype.decide = function () {
    ...
    PostHogFeatureFlags.prototype.getFlagPayloads = function () {
        ...
        var overriddenPayloads = this.instance.get_property(PERSISTENCE_OVERRIDE_FEATURE_FLAG_PAYLOADS);
        if (!overriddenPayloads) {
            return flagPayloads || {};
        }
        var finalPayloads = extend({}, flagPayloads || {});
    ...
    PostHogFeatureFlags.prototype.reloadFeatureFlags = function () {
        ...
        this._reloadDebouncer = setTimeout(function () {
            _this._callDecideEndpoint();
        }, 5);
    };
    PostHogFeatureFlags.prototype.clearDebouncer = function () {
     ...
     */
    PostHogFeatureFlags.prototype._callDecideEndpoint = function (options) {
        var _this = this;
        ...
        if ((options === null || options === void 0 ? void 0 : options.disableFlags) || this.instance.config.advanced_disable_feature_flags) {
        ...
        this.instance._send_request({
            ...
            callback: function (response) {
                ...
                if (!_this._decideCalled) {
                    _this._decideCalled = true;
                    _this.instance._onRemoteConfig((_a = response.json) !== null && _a !== void 0 ? _a : {});
                }
        ...
        if (options.send_event || !('send_event' in options)) {
            if (!(key in flagCallReported) || !flagCallReported[key].includes(flagReportValue)) {
                ...
                this.instance.capture('$feature_flag_called', {
                    ...
                    $feature_flag_bootstrapped_response: ((_d = (_c = this.instance.config.bootstrap) === null || _c === void 0 ? void 0 : _c.featureFlags) === null || _d === void 0 ? void 0 : _d[key]) || null,
                    $feature_flag_bootstrapped_payload: ((_f = (_e = this.instance.config.bootstrap) === null || _e === void 0 ? void 0 : _e.featureFlagPayloads) === null || _f === void 0 ? void 0 : _f[key]) || null,
            ...
            if ('flags' in options) {
                if (options.flags === false) {
                    ...
                    if (isArray(options.flags)) {
                        ...
                        this.instance.persistence.register((_b = {}, _b[PERSISTENCE_OVERRIDE_FEATURE_FLAGS] = options.flags, _b));
                    }
                }
            }
